...
class Base:
    def __init__(self, player):
        ...
        # self.kitImg = Image.open("images/kit2.png").resize((self.cellSize-2, self.cellSize-2)) #CHANGE THIS BACK !!!
        # self.catImg = Image.open("images/cat2.png").resize((self.cellSize-2, self.cellSize-2)) #CHANGE THIS BACK !!!
        self.kitImg = Image.open(r"C:\Users\adamj\Downloads\boopbalicek\boopbalicek\boop-balicek\images\kit2.png").resize((self.cellSize-2, self.cellSize-2))
        self.catImg = Image.open(r"C:\Users\adamj\Downloads\boopbalicek\boopbalicek\boop-balicek\images\cat2.png").resize((self.cellSize-2, self.cellSize-2))
